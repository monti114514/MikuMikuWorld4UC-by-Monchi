	...
	void DrawData::calculateDrawData(Score const &score)
	{
		...
		try
		{
			...
			for (int layer = 0; layer < score.layers.size(); ++layer)
			{
				...
				// 繝・Φ繝昴→HS縺悟､牙喧縺吶ｋ蜈ｨ縺ｦ縺ｮTick・亥｢・阜轤ｹ・峨ｒ蜿朱寔
			...
			// =========================================================================
			// 縲仙､画峩縲大酔縺狼ick縺ｫ蟄伜惠縺吶ｋ繝弱・繝・・ <荳ｭ蠢ス蠎ｧ讓・ 繝ｬ繧､繝､繝ｼ> 縺ｮ繝ｪ繧ｹ繝医ｒ菫晄戟縺吶ｋ
			// =========================================================================
