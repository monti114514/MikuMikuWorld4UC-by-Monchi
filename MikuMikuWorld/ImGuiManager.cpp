    ...
    DockNode          ID=0x00000002 Parent=0x00000008 SizeRef=863,765 Split=Y
      ...
      DockNode        ID=0x00000006 Parent=0x00000002 SizeRef=250,429 Split=X Selected=0x25F8FF00
        DockNode      ID=0x00000003 Parent=0x00000006 SizeRef=530,829 Split=X Selected=0x25F8FF00
          DockNode    ID=0x0000000B Parent=0x00000003 SizeRef=552,429 Split=X Selected=0x25F8FF00
            DockNode  ID=0x0000000C Parent=0x0000000B SizeRef=262,429 Selected=0x25F8FF00
            DockNode  ID=0x0000000D Parent=0x0000000B SizeRef=288,429 Selected=0x46855A0D
          DockNode    ID=0x0000000E Parent=0x00000003 SizeRef=309,429 Selected=0xD503FE8A
